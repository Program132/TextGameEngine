...
def make_player():
    ...
    base_head_offset_y = 0

    player.set_part_offset("head", 0, base_head_offset_y)
    ...
    walk_anim.add_keyframe(Keyframe(0.0, target=head, y=start_y + base_head_offset_y - 1))
    walk_anim.add_keyframe(Keyframe(0.2, target=head, y=start_y + base_head_offset_y))
    ...
    idle_anim.add_keyframe(Keyframe(0.0, target=head, y=start_y + base_head_offset_y))
    idle_anim.add_keyframe(Keyframe(0.5, target=head, y=start_y + base_head_offset_y - 1))
    idle_anim.add_keyframe(Keyframe(1.0, target=head, y=start_y + base_head_offset_y))
